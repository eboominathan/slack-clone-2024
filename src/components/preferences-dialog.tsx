        ...
        <Tabs orientation='horizontal' defaultValue='themes'>
          <TabsList>
            <TabsTrigger value='themes'>
              ...
              <Typography text='Themes' variant='p' className=''/>
            </TabsTrigger>
          </TabsList>
          <TabsContent className='max-w-xs md:max-w-fit' value='themes'>
            ...
            <div className='flex flex-wrap gap-3'>
              ...
              >
                ...
                <Typography text='Light' variant='p' className=''/>
              </Button>
              <Button
                variant='outline'
              ...
              >
                ...
                <Typography text='Dark' variant='p' className=''/>
              </Button>
              <Button
                variant='outline'
              ...
              >
                <MdLightMode className='mr-2' size={20} />
                <Typography text='System' variant='p' className=''/>
              </Button>
            </div>
