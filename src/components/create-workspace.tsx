    ...
    >
      <DialogTrigger>
        <div className='flex items-center gap-2 p-2'>
          ...
          <Typography variant='p' text='Add Workspace' className=''/>
        </div>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className='my-4'>
            <Typography variant='h4' text='Create workspace'  className=''/>
          </DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    <Typography text='Name' variant='p'  className=''/>
                  </FormLabel>
                  <FormControl>
            ...
            <Button disabled={isSubmitting} type='submit'>
              <Typography variant='p' text='Submit'  className=''/>
            </Button>
          </form>
        </Form>
      </DialogContent>
