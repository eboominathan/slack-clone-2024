      ...
      <form className='mt-6'>
        <fieldset>
          ...
          <Button
            ...
            disabled={!name}
          >
            <Typography text='Next' variant='p' className=''/>
          </Button>
        </fieldset>
      </form>
    </>
...
const Step2 = () => {
  ...
  return (
    <>
      ...
      >
        <Typography text='Back' variant='p' className=''/>
      </Button>
      ...
      <form>
        ...
        >
          ...
          <div className='space-x-5'>
            ...
            >
              <Typography text='Skip for now' variant='p' className=''/>
            </Button>
            ...
            {imageUrl ? (
              <Button
                ...
                variant='destructive'
              >
                <Typography text='Submit' variant='p' className=''/>
              </Button>
            ) : (
              <Button
                type='button'
              ...
              >
                <Typography text='Select an Image' variant='p' className=''/>
              </Button>
            )}
          </div>
        </fieldset>
